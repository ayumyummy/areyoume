      ...
      <h2 className="section__title-main"><span className="numbering">#1</span>
        ...
        <div className="block-indent title">
          <h3>
            ...
            <p className="indent-3">c. I work hard, but dream bigger. I want to inspire and impress a whole world of people, including my Mum and Dad *heart emoji*</p>
          </h3>
        </div>
        <div className="block-indent title">
          <h3>
            ...
            <p className="indent-3">a. I love animation and ability to bring a website/application/whatever to life.</p>
            <p className="indent-3">b. I spend a lot of time learning new techniques and implementation with technology, so my work enhances.</p>
          </h3>
        </div>
        <div className="block-indent title">
          <h3>
            ...
            <p className="indent-3">b. I also make the best popcorn in the world, so my mum tells me.</p>
          </h3>
        </div>
